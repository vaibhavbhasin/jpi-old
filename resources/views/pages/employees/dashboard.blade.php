                            ...
                            <div class="card-title">
                                <div class="row">
                                    ...
                                    <div class="col s12 m6 l4 text-right">
                                        <!-- remove class 'hide' -->
                                        <button type="button" class="waves-effect apj-cancel-btn btn" id="edit_details_cancel_btn" style="display: none;">Cancel</button>
                                        <!-- remove class 'hide' -->
                                        <button type="button" class="waves-effect apj-save-btn btn" id="edit_details_save_btn" style="display: none;">Save</button>
                                        <button type="button" class="waves-effect apj-edit-btn btn " id="edit_details_btn">Edit</button>
                                    </div>
                                </div>
                                    ...
                                    <div class="col s6">
                                        <div class="row">
                                            <div class="input-field col s6">
                                                <input id="address1" name="address1" type="text" class="validate" value="{{$employee_details['address1'] ?? ''}}" disabled>
                                                <label for="address1">Address 1</label>
                                            </div>
                                            <div class="input-field col s6">
                                                <input id="address2" name="address2" type="text" class="validate" value="{{$employee_details['address2'] ?? ''}}" disabled>
                                                <label for="address2">Address 2</label>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="input-field col s6">
                                                <input id="city" name="city" type="text" class="validate" value="{{$employee_details['city'] ?? ''}}" disabled>
                                                <label for="city">City</label>
                                            </div>
                                            <div class="input-field col s6">
                                                <input id="state" name="state" type="text" class="validate" value="{{$employee_details['state'] ?? ''}}" disabled>
                                                <label for="state">State</label>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="input-field col s12">
                                                <input id="zip" name="zip" type="text" class="validate" value="{{$employee_details['zip'] ?? ''}}" disabled>
                            ...
                            <div class="row">
                                <div class="col s12">
                                    <form class="">
                                        <div class="row">
                                            <div class="input-field col s12">
                                                <input id="address1-pop" type="text" class="validate" value="{{$employee_details['address1'] ?? ''}}">
                                                <label for="address1-pop">Address 1</label>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="input-field col s12">
                                                <input id="address2-pop" type="text" class="validate" value="{{$employee_details['address2'] ?? ''}}">
                                                <label for="address2-pop">Address 2</label>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="input-field col s6">
                                                <input id="city-pop" type="text" class="validate" value="{{$employee_details['city'] ?? ''}}">
