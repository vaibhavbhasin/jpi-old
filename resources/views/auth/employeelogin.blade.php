  ...
  <div class="col s12 m6 l4 z-depth-4 card-panel border-radius-6 login-card bg-opacity-8 min-hig">
	<div class='loginbtndisplay text-center'>
		...
		<div class='text-center'>
			<a href="{{route('employeeRegistrationForm')}}" class='defaultbtn'>Register</a>
			<div class='loginseparator'>or</div>
			<a href="javascript:void(0)" id='userform' class='btn btn btn-light-cyan'>Login</a>
		</div>

	</div>

    <form class="login-form" method="POST" action="{{ route('employeelogin') }}" style='display:none;'>
      @csrf
      <!--<div class="row">
