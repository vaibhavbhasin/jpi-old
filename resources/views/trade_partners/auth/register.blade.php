...
<div id="register-page" class="row">
    <div id="register-inner-page" class="col s12 m6 l4 z-depth-4 card-panel border-radius-6 register-card bg-opacity-1">
        <form class="login-form" method="POST" action="{{ route('admin.register.submit') }}">
                ...
                <div class="col s12">
                    <div class="row">
                        <div class="input-field col s6 padding_kl">
                            ...
                            <input id="firstname" type="text" class="@error('firstname') is-invalid @enderror" name="firstname" value="{{ old('firstname') }}" autocomplete="firstname">
            ...
            <div class="row margin">
                <div class="input-field col s12">
                    ...
                    <input id="email" type="text" class="@error('email') is-invalid @enderror" value="{{ old('email') }}" autocomplete="email">
            ...
            <div class="row">
                <div class="input-field col s12 mt--6">
                    <p class="margin center-align medium-small"><a href="{{ route('tpportal.login')}}" class="forgot-pasw-text">Already have an
                            account? Login</a></p>
                </div>
            </div>
        </form>
