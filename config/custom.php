...
return [
    'custom' => [
		...
		//we used saparete log image for large screen and small
        // 'smallScreenLogo' => 'images/logo/materialize-logo.png', 
		// pass the image path here e.g:'images/logo/materialize-logo-color.png' note:(Vertical-menu-nav-dark and horizontal-menu template used a single logo in both small and large screen)
		'largeScreenLogo' => 'images/jpi_logo.png', 
        'smallScreenLogo' => 'images/jpi_logo.png', 
